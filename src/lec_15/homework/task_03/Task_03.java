...
public class Task_03 {
    ...
    private static void fillMap(HashMap<String, List<Integer>> filledMap, int multiplier) {
        for (int i = 1; i < 10; i++) {
            List<Integer> tempList = new ArrayList<>();
            for (int j = 1; j < 10; j++) {
                tempList.add(i * j * multiplier);
            }

            filledMap.put("key_" + i, tempList);
        }
    }
}
